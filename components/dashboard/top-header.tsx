...
export function DashboardTopHeader({ userLabel, userBalance }: DashboardTopHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-lime-200/80 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-[4.5rem] max-w-[1600px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="space-y-0.5">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-lime-600/90">
            AI ASO Generator
          </p>
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="sm"
            className="text-lime-700/80 hover:text-lime-900"
          >
          ...
          <Button
            variant="outline"
            size="sm"
            className="gap-2 rounded-full border-lime-200/80 bg-lime-50/70 text-lime-900"
            disabled
          >
          ...
          <Button
            variant="outline"
            size="sm"
            className="rounded-full border-lime-300/80 bg-lime-100/80 text-lime-900"
            disabled
          >
            {userBalance} credits
          </Button>
